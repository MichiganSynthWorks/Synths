...
namespace avrlib {
static uint16_t SwitchA_count = 0;
static uint16_t SwitchB_count= 0;
    
    //EDIT THIS FOR SPEED, LOWER = FASTER
    const uint16_t TIMEUP = 2000;//depends on how many times this is called per second
